...
public class ExperienceCellInventory implements StorageCell {
  ...
  public ExperienceCellInventory(IExperienceCellItem cell, ItemStack stack, ISaveProvider container) {
    ...
    this.amount = stack.getOrDefault(AEComponents.EXPERIENCE_CELL_AMOUNT, 0L);
  }
  ...
  public void persist() {
    ...
    if (amount < 0) {
      stack.remove(AEComponents.EXPERIENCE_CELL_AMOUNT);
    } else {
      stack.set(AEComponents.EXPERIENCE_CELL_AMOUNT, amount);
    }
